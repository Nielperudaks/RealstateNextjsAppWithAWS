    ...
    <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          {Object.entries(PropertyTypeIcons).map(([type, Icon]) => (
            <div
              key={type}
              className={cn(
                "flex flex-col items-center justify-center p-4 shadow-sm border rounded-xl text-primary hover:bg-secondary",
      ...
      <div className="flex gap-4 mt-4">
        <div className="flex-1">
          ...
          >
            <SelectTrigger className="w-full rounded-xl shadow border  text-primary">
        ...
        <div className="flex flex-wrap gap-2">
          {Object.entries(AmenityIcons).map(([amenity, Icon]) => (
            <div
              key={amenity}
              className={cn(
                "flex items-center space-x-2 p-2 border rounded-lg text-primary shadow-xs hover:bg-secondary",
      ...
      <div className="mt-4">
        ...
        <Input
          ...
          className="rounded-xl shadow border text-primary"
        />
      </div>
