      ...
      <div className="border rounded-lg p-6">
        <div>
          ...
          <div className="flex justify-end">
            <button className="bg-primary border text-primary-foreground py-2 px-4 rounded-md flex items-center justify-center hover:bg-primary/90">
  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden p-6 flex-1 flex flex-col justify-between">
      ...
      <div className="flex justify-end gap-2 w-full">
        <button className="bg-secondary border text-secondary-foreground py-2 px-4 rounded-md flex items-center justify-center hover:bg-secondary/70">
          Manager
        </button>
        <button className="bg-primary border text-primary-foreground py-2 px-4 rounded-md flex items-center justify-center hover:bg-primary/90">
          ...
          <TableBody>
            {payments.map((payment) => (
              <TableRow key={payment.id} className="h-16">
                ...
                <TableCell>
                  <button className="bg-white border text-gray-700 py-2 px-4 rounded-md flex items-center justify-center hover:bg-gray-100">
